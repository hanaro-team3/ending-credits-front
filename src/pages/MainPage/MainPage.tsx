    ...
    <styled.Section>
        ...
        <styled.StatusCard>
            <styled.StatusContent>
                ...
                <styled.StatusDescription><span className="highlight">사망 후</span>공유대상자에 의해<br />
                해당 유언장이 공유됩니다.</styled.StatusDescription>
            </styled.StatusContent>
...
const CarouselSection = () => (
    <styled.Carousel>
        {[
            { color: "#FFD998", title: "장례절차는 어떻게 이루어지나요?", category: "장례식" },
            { color: "#98B2FF", title: "공증 수수료는 어떻게 되나요?", category: "상속유언" },
            { color: "#FF989A", title: "장례절차는 어떻게 이루어지나요?", category: "장례식" }
        ].map((item, index) => (
            <styled.CarouselItem key={index} $bgColor={item.color}>
                <styled.CarouselDescription>{item.category}</styled.CarouselDescription>
...
const BannerSection = () => (
    <styled.Banner>
        ...
        <styled.BannerContent>
            <styled.BannerDescription>미리 준비하는 나만의 상속 설계</styled.BannerDescription>
            <styled.BannerTitle>미리 준비하는 나만의 상속 설계</styled.BannerTitle>
        </styled.BannerContent>
    </styled.Banner>
);
