...
interface VerificationStep1Props {
	...
	onNext: (updatedData: RealEstateData[]) => void;
	onPrev: () => void;
}
...
export const VerificationStep1: React.FC<VerificationStep1Props> = ({
	...
	const [editData, setEditData] = useState<RealEstateData[]>(realEstateData);
	...
	return (
		<styled.UploadPageContainer>
			<styled.TopContainer>
				<styled.Title>
					<span style={{ color: "#4792dc" }}>부동산 자산</span> 확인
				</styled.Title>
				<styled.SubTitle>
					녹음하신 내용을 바탕으로 분석된 부동산 자산 정보입니다.
					내용을 확인해주세요.
				</styled.SubTitle>
			</styled.TopContainer>
